...
PACKAGE = ROOT / "engines" / "ai_reasoning_v2"
...
def test_architecture_has_no_forbidden_imports_calls_or_private_dependency_access():
    forbidden_imports = {
        "asyncio",
        "multiprocessing",
        "queue",
...
def test_v1_and_market_context_v2_remain_separate():
    assert (ROOT / "engines" / "ai_reasoning").exists()
