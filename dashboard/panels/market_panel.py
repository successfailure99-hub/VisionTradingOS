...
class MarketPanel(QGroupBox):
    def __init__(self, parent=None):
        ...
        self._fields = (
            ...
            "VWAP Venue", "VWAP Expiry", "VWAP Volume", "VWAP Source Price",
            "VWAP Status", "VWAP Message", "VWAP Subscription", "VWAP History Candles",
            "VWAP History Volume", "Historical Seed Complete", "Bootstrap Time", "Live Tick Count",
            "Last Live Volume", "Last Delta Volume", "Current Accumulated Volume", "VWAP Last Tick", "VWAP Error",
            "CPR Pivot", "CPR BC",
    ...
    def render(self, view: DashboardMarketView) -> None:
        ...
        values = {
            ...
            "VWAP Status": view.vwap_source_state,
            "VWAP Message": view.vwap_source_message,
            "VWAP Subscription": "Active" if view.vwap_subscription_active else "-",
            "VWAP History Candles": formatters.integer(view.vwap_historical_candles_loaded),
            "VWAP History Volume": formatters.integer(view.vwap_historical_volume),
            "Historical Seed Complete": "Yes" if view.vwap_historical_seed_complete else "-",
            "Bootstrap Time": formatters.timestamp(view.vwap_bootstrap_time),
            "Live Tick Count": formatters.integer(view.vwap_live_tick_count),
            "Last Live Volume": formatters.integer(view.vwap_last_live_volume),
            "Last Delta Volume": formatters.integer(view.vwap_last_delta_volume),
            "Current Accumulated Volume": formatters.integer(view.vwap_current_accumulated_volume),
            "VWAP Last Tick": formatters.timestamp(view.vwap_last_live_tick),
            "VWAP Error": view.vwap_last_error,
